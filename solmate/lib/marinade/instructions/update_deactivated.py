...
# LOCK-BEGIN[ix_cls(update_deactivated)]: DON'T MODIFY
@dataclass
class UpdateDeactivatedIx:
    ...
    def to_instruction(self):
        ...
        buffer = BytesIO()
        buffer.write(InstructionTag.to_bytes(InstructionTag.UPDATE_DEACTIVATED))
...
# LOCK-BEGIN[ix_fn(update_deactivated)]: DON'T MODIFY
