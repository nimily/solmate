...
# LOCK-BEGIN[ix_cls(burn_checked)]: DON'T MODIFY
@dataclass
class BurnCheckedIx:
    ...
    def to_instruction(self):
        ...
        buffer = BytesIO()
        buffer.write(InstructionTag.to_bytes(InstructionTag.BURN_CHECKED))
...
# LOCK-BEGIN[ix_fn(burn_checked)]: DON'T MODIFY
def burn_checked(
