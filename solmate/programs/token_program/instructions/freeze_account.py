...
# LOCK-BEGIN[ix_cls(freeze_account)]: DON'T MODIFY
@dataclass
class FreezeAccountIx:
    ...
    def to_instruction(self):
        ...
        buffer = BytesIO()
        buffer.write(InstructionTag.to_bytes(InstructionTag.FREEZE_ACCOUNT))
...
# LOCK-BEGIN[ix_fn(freeze_account)]: DON'T MODIFY
def freeze_account(
