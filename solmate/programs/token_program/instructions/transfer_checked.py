...
# LOCK-BEGIN[ix_cls(transfer_checked)]: DON'T MODIFY
@dataclass
class TransferCheckedIx:
    ...
    def to_instruction(self):
        ...
        buffer = BytesIO()
        buffer.write(InstructionTag.to_bytes(InstructionTag.TRANSFER_CHECKED))
...
# LOCK-BEGIN[ix_fn(transfer_checked)]: DON'T MODIFY
